...
const MASTER_TL = timeline({
  ...
  onComplete: () => {
    ...
    // ✅ Show final button after animation ends
    setTimeout(() => {
...
BTN.addEventListener('click', () => {
  // Unmute all sounds when the user clicks the button
...
new TypeIt("#finalText", {
  ...
  .type("This is not the end…")
  .pause(300)
  .break()
  .type("One last thing!")
  .pause(500)
  .break()
  .type("Happy Birthday, Duniyaa ❤️")
  .pause(300)
  .break()
  .type("You're special, you're amazing, and today is all about celebrating YOU 🎉🎂")
  .go();
